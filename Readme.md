...
- 兼容性要求：需配合 MC-miner 服务端 v4.5.0 及以上版本，即可启用 RMS3 协议。
...
### 图形化界面版本
- 下载地址：  
  https://github.com/mc-miner/RMS3/raw/main/windows-gui/rms.exe
  
- 如遇白屏问题，请安装 WebView2：  
  https://github.com/mc-miner/RMS3/raw/main/windows-gui/MicrosoftEdgeWebview2Setup.exe

### 非图形化命令行版本
- 下载地址：  
    https://github.com/mc-miner/RMS3/raw/main/windows-no-gui/rms.exe
...
```
bash <(curl -s -L https://raw.githubusercontent.com/mc-miner/RMS3/main/OLD_2/install.sh)
```
